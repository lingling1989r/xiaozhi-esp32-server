...
class AsyncPerformanceTester:
    ...
    async def run(self):
        ...
        # LLM测试任务
        test_llm = {
            'LLM_CozeLLM': {'type': 'coze', 'bot_id': '7488612156498657290', 'user_id': '321', 'personal_access_token': 'pat_k6QSXJUC9oCYiFfNqqqHgab9tjQBkgn6Z1iWMwvJebmjcXqnjfFRVZpUZmVpT8Ez'},
            'LLM_AliLLM': {'type': 'openai', 'top_k': '50', 'top_p': '1', 'api_key': 'sk-427fd96514ad49d587a5f0c6393b1a5f', 'base_url': 'https://dashscope.aliyuncs.com/compatible-mode/v1', 'max_tokens': '500', 'model_name': 'qwen-turbo', 'temperature': '0.7', 'frequency_penalty': '0'},
            'LLM_ChatGLMLLM': {'type': 'openai', 'top_k': '', 'top_p': '', 'api_key': '21222311664c40bb8b554e621ada2be7.VKyuwBUTsFyxIcNh', 'base_url': 'https://open.bigmodel.cn/api/paas/v4/', 'max_tokens': '', 'model_name': 'glm-4-flash', 'temperature': '', 'frequency_penalty': ''}
            }
        # for llm_name, config in self.config.get("LLM", {}).items():
        for llm_name, config in test_llm.items():
            # 检查配置有效性
            if llm_name == "CozeLLM":
